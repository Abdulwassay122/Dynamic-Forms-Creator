        ...
        <div className="px-4 lg:px-6 sm:py-10 py-2  flex flex-col gap-10">
            ...
            {!loading && !Error ?
                <div className="flex flex-col gap-5">
                                ...
                                {Object.entries(
                                    ...
                                    <Fragment key={formId}>
                                        ...
                                        {responses.map((response: any) => (
                                            <TableRow key={response._id} className="group bg-gray-50 h-10">
                                                <TableCell className="px-6 py-3 flex justify-between items-center text-gray-700 font-medium">
                                                    ...
                                                    <Button
                                                        onClick={() => handleClick(response.formId, response._id)}
                    ...
                    </div> : <div className="text-md text-center">No result found!</div>} </div> : !loading && <div className="text-xl font-semibold flex items-center justify-center text-center flex-col gap-3 h-screen"><img src={wrong} className="h-auto w-[60px]" />Oops! <br />Something Went Wrong.</div>}
            {totalPages > 1 && (
                <Pagination>
                    <PaginationContent>
                        <PaginationItem>
