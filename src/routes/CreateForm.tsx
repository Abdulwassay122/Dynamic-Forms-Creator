...
export default function CreateForm() {
    ...
    return (
        <section className="px-48 py-20 flex flex-col gap-10 bg-gray-100">
            <h1 className="text-3xl font-semibold  px-10 py-10  bg-white rounded-md border-t-8 border-[#101828]">Create a New Form</h1>

            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                <div className=" px-10 py-10 flex flex-col gap-6  bg-white rounded-md border-l-8 border-[#101828]">
                    {/* Title */}
                    <div className="">
